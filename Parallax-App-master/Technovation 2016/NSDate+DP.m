...
+ (NSInteger) monthsDifferenceBetweenStartDate:(NSDate *)startDate endDate:(NSDate *)endDate {
    ...
    NSDateComponents *startDateComponents = [calendar components:NSCalendarUnitYear|NSCalendarUnitMonth fromDate:startDate];
    NSDateComponents *endDateComponents = [calendar components:NSCalendarUnitYear|NSCalendarUnitMonth fromDate:endDate];
